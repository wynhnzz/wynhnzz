...
Run by .github/workflows/contribution-graph.yml after fetch_contributions.py.
"""
import datetime
import json
import os
...
OUT_PATH = os.path.join(HERE, "..", "generated", "contrib-heatmap.svg")
...
""".strip()
    ...
    parts.append(f'<text x="{canvas_w/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
                 f'text-anchor="middle">wynhnzz@github: ~/contributions --graph</text>')
